 ...
 // repetir até desejar parar 
    ...
    { 
     ...
     // ler do teclado 
        IO_println ( "Opcoes"  ); 
        IO_println ( " 0 - parar" ); 
        IO_println ( " 1 - Method 01 repeticao com teste no inicio" ); 
        IO_println ( " 2 - Method 02 Repeticao com teste no inicio" ); 
        IO_println ( " 3 - Method 03 Repeticao com teste no inicio ");
        IO_println ( " 4 - Method 04 Repeticao com teste no inicio e variacao");
        IO_println ( " 5 - Method 05 Repeticao com teste no inicio e variacao. ");
        IO_println ( " 6 - Method 06 Repeticao sobre cadeia de caracateres.");
        IO_println ( " 7 - Method 07 Repeticao sobre cadeia de caracateres.");
        IO_println ( " 8 - Method 08 Repeticao com intervalos. ");
        IO_println ( " 9 - Method 09 Repeticao com intervalos. ");
        IO_println ( "10 - Method 10 Repeticao com confirmacao. ");
     ...
     // testar valor 
        ...
        { 
          ...
          default: 
            IO_pause ( IO_concat ( "Valor diferente das opcoes [1 a 10] (", 
