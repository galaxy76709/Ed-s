 ...
 // repetir até desejar parar 
    ...
    { 
     ...
     // ler do teclado 
        ...
        IO_println ( " 1 - Method_01 Repeticao para ler certa quantidade de valores." );
        IO_println ( " 2 - Method_02 Ler valores e contar positivos." ); 
        IO_println ( " 3 - Method_03 Ler valores e contar positivos menores que 100.");
        IO_println ( " 4 - Method_04 Ler valores e contar positivos menores que 100 e pares.");
        IO_println ( " 5 - Method_05 Ler valores e contar positivos menores que 100 e pares (alternativo).");
        IO_println ( " 6 - Method_06 Ler palavra e contar letras minusculas.");
        IO_println ( " 7 - Method_07 Ler palavra, contar e mostrar letras minusculas.  ");
        IO_println ( " 8 - Method_08 Ler palavra, contar e mostrar letras minusculas (alternativo). ");
        IO_println ( " 9 - Method_09 Ler palavra e contar os algarismos. ");
